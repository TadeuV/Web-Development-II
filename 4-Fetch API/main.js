...
let uldel = document.getElementById("available-posts");

  uldel.addEventListener("click",function(e){
    tar=e.target;

    let btndel=tar.parentNode.lastElementChild
    
    console.log(tar.innerHTML);
    if (btndel.innerHTML === "DELETE"){
        let li=btndel.parentNode
        // console.log(li);
